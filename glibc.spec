...
cp crypt/libcrypt.so %{buildroot}/usr/lib64/haswell/libcrypt-2.28.so
...
ln -s libcrypt-2.28.so %{buildroot}/usr/lib64/haswell/libcrypt.so.1
...
/usr/lib64/libnss_hesiod-2.28.so
